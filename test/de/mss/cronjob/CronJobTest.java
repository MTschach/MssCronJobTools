...
public class CronJobTest extends TestCase {
   ...
   public void testDefaultFirstRun() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-10 12:13:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testMultipleValues() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-10 12:30:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testDefinedInterval() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-10 12:11:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testInterval() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-10 12:20:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testNextHour() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-27 11:00:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testNextDay() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-23 08:00:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testNextMonth() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-12-01 08:00:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testNextDayOfNextMonth() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-11-01 08:00:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void testNextDayOfWeek() throws ParseException {
      ...
      assertEquals("should execute", Boolean.TRUE, Boolean.valueOf(this.classUnderTest.shouldExecute()));
      assertEquals("next exec time", "2020-10-26 08:00:00", formatTime(this.classUnderTest.getNextExecTime()));
   }
   ...
   public void test() {
      ...
      assertEquals("Task", "testTask", this.classUnderTest.getExecTask());
   }
